...
import dev.jqb.onefeed.mapper.json.AggregationResponse;
import dev.jqb.onefeed.mapper.json.FeedCursorResponse;
import dev.jqb.onefeed.mapper.json.OneFeedActorResponse;
import dev.jqb.onefeed.mapper.json.OneFeedContentResponse;
import dev.jqb.onefeed.mapper.json.PlatformResponse;
import dev.jqb.onefeed.mapper.json.StdResponseMapper;
import dev.jqb.onefeed.mapper.json.StreamElement;
import dev.jqb.onefeed.mapper.json.Streamable;
import dev.jqb.onefeedserver.aggregation.CustomAggregation.WeightedFeed;
